...
\ExplSyntaxOff
Test: \begingroup
  \colorselect{rgb}{\ApplyProfile delim, \sRGB 1 \fogra 0.9 0.1 0.1 0 }%
  \vrule width 5em
  \colorselect{srgb}{\ApplyProfile delim, \sRGB 1 \fogra 0.9 0.1 0.1 0 }%
  \vrule width 5em
  \colorselect{fogra}{0.9,0.1,0.1,0}%
  \vrule width 5em
  \colorselect{cmyk}{0.9,0.1,0.1,0}%
  \vrule width 5em
  \expandafter\def\csname l_color_fixed_model_tl\endcsname{rgb}%
  \colorselect{cmyk}{0.9,0.1,0.1,0}%
  \vrule width 5em
\endgroup
...
\colorselect{srgb}{\ApplyProfile delim, \sRGB 1 \fogra 0.9 0.1 0.1 0 }
\begin{tabular}{ll}
  sRGB black --- fogra cyan (in sRGB)&\iterate{
    \colorselectN{BLK!#1/10!cyan}\vrule width .1pt
  }\\
  red --- cyan&\iterate{
    \colorselectN{red!#1/10!cyan}\vrule width .1pt
  }\\
  sRGB red --- sRGB cyan&\iterate{
